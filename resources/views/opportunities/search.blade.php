<x-app-layout>
    <div class="py-6 flex flex-col items-center w-full">
        <div class="flex flex-col max-w-8xl mx-auto sm:px-6 lg:px-8 w-full justify-center items-center">
            ...
            <form action="{{ route('opportunities.search') }}" method="GET" class="flex items-center mb-4 w-full max-w-5xl flex justify-center">
                                ...
                                @foreach ($clients as $client)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                            <a href="{{ route('opportunities.new', $client) }}" class="text-lime-600 ">
                                                {{ $client->name }}
                                            </a>
                                        </td>
