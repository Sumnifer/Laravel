                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            @foreach ($tickets as $ticket)
                                @if($ticket->status == 'Non Traité')
                                    <tr class="bg-orange-200 border-l-4 !border-l-orange-500">
                                @elseif($ticket->status == 'En Cours')
                                    <tr class="bg-blue-200 border-l-4 !border-l-blue-500 !border-b-0">
                                @elseif($ticket->status == 'Résolu')
                                    <tr class="bg-lime-200 border-l-4 !border-l-lime-500  !border-b-0">
                                @else
                                    <tr class="">
                                @endif
