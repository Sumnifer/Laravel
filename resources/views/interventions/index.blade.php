<x-app-layout>
    <div class="py-6 flex flex-col items-center w-full">
        <div class="flex flex-col max-w-8xl mx-auto sm:px-6 lg:px-8 w-full">
            ...
            <a href="#" class="bg-lime-600 py-2 px-6 text-white rounded-md w-auto flex flex-row justify-center items-center gap-2 text-[1rem] self-end w-[10%] mb-4">Archive <i class="fa-solid fa-archive text-[1rem]"></i></a>
        </div>
                                ...
                                @foreach ($interventions as $intervention)
                                    <tr class="">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 flex gap-2">
                                            <a href="{{ route('interventions.edit', $intervention) }}" class="text-lime-600">
